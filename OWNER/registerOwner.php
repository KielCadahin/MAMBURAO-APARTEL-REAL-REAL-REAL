...
if (isset($_POST["create"])) {
   ...
   //  $_profile_picture = $_POST["_profile_picture"];
    ...
    $sql = "INSERT INTO tblowner (_username, _email, _password, _apartment_name, _full_name, _gender, _country, _municipality, _phone_number, _address, _bank_account) 
    VALUES ('$_username','$_email', '$_password','$_apartment_name','$_full_name','$_gender', '$_country', '$_municipality', '$_phone_number', '$_address', '$_bank_account')";
